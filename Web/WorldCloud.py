...
def get_news():
    ...
    #title1_163 = r.html.find('#js_top_news > div.news_default_news.news_news_show > h2 > a', first=True)
    titles_163 = r.html.find('#js_top_news > div.news_default_news.news_news_show > ul > li:nth-child(n) > a:nth-child(n) > em')
